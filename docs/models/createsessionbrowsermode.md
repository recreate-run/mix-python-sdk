...
| Name                        | Value                       |
| --------------------------- | --------------------------- |
| `ELECTRON_EMBEDDED_BROWSER` | electron-embedded-browser   |
| `LOCAL_BROWSER_SERVICE`     | local-browser-service       |
| `REMOTE_CDP_WEBSOCKET`      | remote-cdp-websocket        |
...
class Sessions(BaseSDK):
    def list(
        self,
        *,
        include_subagents: Optional[bool] = False,
        ...
        :param include_subagents: Include subagent sessions in response (default: false, subagent sessions are hidden)
    ...
    def update_session_callbacks(
        self,
        *,
        id: str,
        callbacks: Union[List[models.Callback], List[models.CallbackTypedDict]],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SessionData:
        r"""Update session callbacks
        ...
        request = models.UpdateSessionCallbacksRequest(
            id=id,
            request_body=models.UpdateSessionCallbacksRequestBody(
                callbacks=utils.get_pydantic_model(callbacks, List[models.Callback]),
            ),
        )

        req = self._build_request(
            method="PATCH",
            path="/api/sessions/{id}/callbacks",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="updateSessionCallbacks",
                oauth2_scopes=None,
                security_source=None,
            ),
            request=req,
    ...
    async def update_session_callbacks_async(
        self,
        *,
        id: str,
        callbacks: Union[List[models.Callback], List[models.CallbackTypedDict]],
    ...
    def export_session(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ExportSessionResponse:
        r"""Export session transcript
        ...
        request = models.ExportSessionRequest(
            id=id,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.ExportSessionResponse(
                result=unmarshal_json_response(models.ExportSession, http_res),
    ...
    def rewind_session(
        ...
        *,
        id: str,
        message_id: str,
        cleanup_media: Optional[bool] = True,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        :param id: Session ID to rewind
        :param message_id: ID of the last message to keep. All messages after this message will be deleted.
        :param cleanup_media: Whether to clean up media files created after the rewind point (based on file timestamp)
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.RewindSessionRequest(
            id=id,
            request_body=models.RewindSessionRequestBody(
    ...
    async def rewind_session_async(
        self,
        *,
        id: str,
        message_id: str,

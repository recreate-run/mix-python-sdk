...
import httpx
from mix_python_sdk import errors, utils
from mix_python_sdk._hooks import (
    AfterErrorContext,
    AfterSuccessContext,
    BeforeRequestContext,
)
from mix_python_sdk.utils import RetryConfig, SerializedRequestBody, get_body_content
        ...
        def do():
            ...
            if utils.match_status_codes(error_status_codes, http_res.status_code):
                ...
                if result is not None:
                    ...
                    raise errors.MixDefaultError("Unexpected error occurred", http_res)

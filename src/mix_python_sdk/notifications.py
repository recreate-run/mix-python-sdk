...
class Notifications(BaseSDK):
    def respond_to_notification(
        ...
        *,
        id: str,
        type_: models.RespondToNotificationType,
        ...
        r"""Respond to notification

        Send user's response to a notification request

        :param id: Notification ID
        :param type: Response type
        :param value: User's text input or selected choice (optional for acknowledge type)
        ...
        request = models.RespondToNotificationRequest(
            id=id,
            request_body=models.RespondToNotificationRequestBody(
                type=type_,
                value=value,
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.RespondToNotificationRequestBody,
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="respondToNotification",
                oauth2_scopes=None,
    ...
    async def respond_to_notification_async(
        self,
        *,
        id: str,
        type_: models.RespondToNotificationType,

...
class Authentication(BaseSDK):
    ...
    def set_api_key(
        ...
        *,
        ...
        request = models.SetAPIKeyRequest(
            api_key=api_key,
        )
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.SetAPIKeyRequest
            ),
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.SetAPIKeyResponse, http_res)
    ...
    def initiate_o_auth_login(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.InitiateOAuthLoginResponse:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.InitiateOAuthLoginResponse, http_res)
    ...
    async def initiate_o_auth_login_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
